...
SWEP.WorldModel = "models/muschi/weapons/muschi_swep_knife.mdl"
SWEP.HoldType = "knife"
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_knife.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.018, 0.518, 2.496), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 17, [2] = 4} }
}

SWEP.WElements = {
	["sword"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_knife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, -3), angle = Angle(90, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {} },
}

SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Mk. XV Talon"
