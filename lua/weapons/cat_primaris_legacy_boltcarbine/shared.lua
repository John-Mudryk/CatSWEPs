...
SWEP.PrintName				= "Bolt Carbine"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-2.086, 0.209, 1.651), angle = Angle(0, 0, 0) },
	...
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-0.539, 27.26, 25.958) },
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-17.161, -19.067, 80.736) }
}
...
SWEP.IronSightsPos = Vector(-4.401, -5, 0.879)
SWEP.IronSightsAng = Vector(-1.903, -1.752, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Cawl Pattern Mk. IIc"

-- Attachments
SWEP.VElements = {
	["mag"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_curve.mdl", bone = "mag_bone", rel = "", pos = Vector(3.075, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["mag2"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_box.mdl", bone = "mag_bone", rel = "", pos = Vector(3.075, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["boltcarbine"] = { type = "Model", model = "models/zadkiel/weapons/primaris_boltcarbine.mdl", bone = "weapon_bone", rel = "", pos = Vector(1.172, 0.597, -1.861), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 2} }
}

SWEP.WElements = {
	["boltcarbine"] = { type = "Model", model = "models/zadkiel/weapons/primaris_boltcarbine.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.835, 3.049, -4.468), angle = Angle(-16.879, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.IronSightsAng_Light = Vector(-0.897, -4.266, 0)

SWEP.IronSightsPos_Heavy = Vector(-4.841, -3, -1.481)
SWEP.IronSightsAng_Heavy = Vector(-1.007, -4.346, 0)