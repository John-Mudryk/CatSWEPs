...
SWEP.VElements = {
	["powerclaw"] = { type = "Model", model = "models/joazzz/chaos/chaosmarines/powerfist_r.mdl", bone = "ValveBiped.Bip01_R_Ulna", rel = "", pos = Vector(10.142, 0.759, 4.235), angle = Angle(17.291, -5.305, 130.897), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 9, bodygroup = {[1] = 2, [2] = 4} }
}

SWEP.WElements = {
	["powerclaw"] = { type = "Model", model = "models/joazzz/chaos/chaosmarines/powerfist_terminator_r.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.821, 5.846, -3.633), angle = Angle(-3.659, -31.937, -91.435), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 9, bodygroup = {[1] = 2, [2] = 4} }
}
