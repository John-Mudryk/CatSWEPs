...
SWEP.PrintName				= "Assault Cannon"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(3.52, -6.652, 0), angle = Angle(0, 0, 0) }

}


SWEP.Primary.Sound			= "weapons/phobosboltgun/fire2.mp3"		-- script that calls the primary fire sound
SWEP.Primary.RPM			= 300		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
-- Attachments
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/terminator_assaultcannon.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.828, 1.452, -0.732), angle = Angle(-6.003, -11.709, 180), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["autocannonW"] = { type = "Model", model = "models/joazzz/weapons/terminator_assaultcannon.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, 0), angle = Angle(-13.249, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
...
function SWEP:Think(...)
    ...
    -- Check if 3 seconds have passed since the trigger was released -- Doesn't work right, reset to 0
