...
SWEP.PrintName				= "Bolt Rifle"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-3.881, -5, 0.56)
SWEP.IronSightsAng = Vector(-0.828, -1.7, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Cawl Pattern Mk. II"

-- Attachments
SWEP.VElements = {
	["mag"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_curve.mdl", bone = "mag_bone", rel = "", pos = Vector(3.483, 0.001, 0), angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["mag2"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_box.mdl", bone = "mag_bone", rel = "", pos = Vector(3.483, 0.001, 0), angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["boltrifle"] = { type = "Model", model = "models/zadkiel/weapons/primaris_boltrifle.mdl", bone = "weapon_bone", rel = "", pos = Vector(0.842, 0, -1.828), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 3} },

	["scope_light"] = { type = "Model", model = "models/rtcircle.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "boltrifle", pos = Vector(-8.127, 0, 8.56), angle = Angle(0, 180, 0), size = Vector(0.55, 0.55, 0.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },
...
SWEP.WElements = {
	["boltrifle"] = { type = "Model", model = "models/zadkiel/weapons/primaris_boltrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.529, 1.264, -3.441), angle = Angle(-12.771, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[7] = 1} }
}
...
SWEP.IronSightsPos_Light = Vector(-4, -3, -0.88)
SWEP.IronSightsAng_Light = Vector(-1.385, -2.643, 0)