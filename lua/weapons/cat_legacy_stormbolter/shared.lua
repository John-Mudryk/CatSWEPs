...
SWEP.PrintName				= "Stormbolter"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/muschi/weapons/muschi_swep_stormbolter_v.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_stormbolter.mdl"	-- Weapon world model
SWEP.ViewModelFlip                      = false
...
SWEP.Primary.Sound			= "40k/b_fire5.wav"		-- script that calls the primary fire sound
...
SWEP.IronSightsAng = Vector(-5.461, -1.948, 0.939)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Mars Pattern Mk. I" 

-- Attachments
SWEP.VElements = {
	["stormbolter"] = { type = "Model", model = "models/joazzz/weapons/stormbolter_standard.mdl", bone = "weapon_bone", rel = "", pos = Vector(1.014, 0.093, -3.3), angle = Angle(90, 180, 0), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope_light"] = { type = "Model", model = "models/rtcircle.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "stormbolter", pos = Vector(8.581, 0, -2.882), angle = Angle(-90, 90, 90), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },

}

SWEP.WElements = {
	["stormbolter"] = { type = "Model", model = "models/joazzz/weapons/stormbolter_standard.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.512, 2.25, -2.356), angle = Angle(-102.205, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.IronSightsPos_Light = Vector(-3.589, -6, 0.075)
SWEP.IronSightsAng_Light = Vector(0.94, -0.69, 0)