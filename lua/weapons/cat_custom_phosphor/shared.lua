...
SWEP.PrintName				= "Phosphor Blast Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= "weapons/eq/irshot.wav"		-- script that calls the primary fire sound
...
SWEP.Primary.DefaultClip		= 64	                -- Default number of bullets in a clip
...
SWEP.IronSightsPos = Vector(-3.467, -6.09, -1.711)
SWEP.IronSightsAng = Vector(2.24, -0.029, -0.09)
...
-- Tracer Stuff
SWEP.TracerName		 = "effect_t_phosphor"   -- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
SWEP.Type                       = "Revolver" 
SWEP.Type_Displayed             = "Goth Mk. III Lantern"
...
SWEP.IronSightsPos_Light = Vector(-3.52, -2, -1.88)
SWEP.IronSightsAng_Light = Vector(-4.009, -0.72, 0)
