...
SWEP.PrintName				= "Volleygun"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/muschi/weapons/muschi_swep_volleygun_v.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_volleygun.mdl"	-- Weapon world model
SWEP.ViewModelFlip                      = false
...
SWEP.IronSightsPos = Vector(-4.12, -8.325, 3.48)
SWEP.IronSightsAng = Vector(-3.07, -1.976, 0)
...
SWEP.Type_Displayed             = "Ryza Pattern Mk. II" 
