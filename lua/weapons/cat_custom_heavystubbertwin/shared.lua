...
SWEP.PrintName				= "Heavy Stubber Twin-linked"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	["weapon_bone"] = { scale = Vector(0.1, 0.1, 0.1), pos = Vector(0, 0, 0), angle = Angle(7.5, 0, 0) }
}

SWEP.Primary.Sound			= "weapons/minigun/mini-1.wav"		-- script that calls the primary fire sound
...
SWEP.Primary.NumShots	= 2		-- How many bullets to shoot per trigger pull, AKA pellets
...
SWEP.Type_Displayed             = "Fortis Pattern Mk. XIV" 
...
SWEP.WElements = {
	["sight"] = { type = "Model", model = "models/wystan/attachments_tfa/doctorrds.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.336, 1.289, -6.877), angle = Angle(11.546, 180, 180), size = Vector(2, 1.72, 2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["element_name"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_stationare_heavy_stubber.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(25.853, 0.638, 0), angle = Angle(167.347, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
