...
SWEP.PrintName = "Power Sword + Combat Shield"
...
SWEP.Primary.Attacks = {
	...
	},
	{
		...
		["delay"] = 0.45, --Delay
		["spr"] = false, --Allow attack while sprinting?
		["snd"] = Sound("weapons/tfa_kf2/zweihander/swing_hard_3.wav"), -- Sound ID
		["snd_delay"] = 0.26,
		["viewpunch"] = Angle(1, 5, 0), --viewpunch angle
		["end"] = 0.8, --time before next attack
		["hull"] = 42, --Hullsize
...
SWEP.VElements = {
	["shield"] = { type = "Model", model = "models/zadkiel/w_shield.mdl", bone = "LeftForeArm_1stP", rel = "", pos = Vector(6.053, -4.659, -17.449), angle = Angle(2.253, 94.565, 0), size = Vector(0.75, 0.75, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 7} },
	["powersword"] = { type = "Model", model = "models/joazzz/weapons/powersword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, -0.051, 10.326), angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 6, [2] = 2} }
}
