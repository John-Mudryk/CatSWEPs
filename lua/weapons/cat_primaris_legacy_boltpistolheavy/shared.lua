...
SWEP.PrintName				= "Heavy Bolt Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 200		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
SWEP.IronSightsPos = Vector(-3.961, -3, -1.52)
SWEP.IronSightsAng = Vector(0.324, -0.047, 0)
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Cawl Pattern Mk. IId"
...
-- Attachments
SWEP.VElements = {
	["boltpistolHeavy"] = { type = "Model", model = "models/zadkiel/weapons/primaris_heavypistol.mdl", bone = "tag_weapon", rel = "", pos = Vector(8.279, 0.637, 1.074), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["boltpistolHeavy"] = { type = "Model", model = "models/zadkiel/weapons/primaris_heavypistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.675, 3.779, -2.073), angle = Angle(-177.793, 172.018, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
