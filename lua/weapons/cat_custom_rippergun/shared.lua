...
SWEP.PrintName				= "Rippergun"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/muschi/weapons/muschi_swep_rippergun_v.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_rippergun.mdl"	-- Weapon world model
SWEP.ViewModelFlip                      = false
...
SWEP.Primary.Sound			= "40k/shotgun-fire2.mp3"		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(2.737, -5.692, 3.338)
SWEP.IronSightsAng = Vector(-0.036, 1.613, 0)
...
SWEP.Type                       = "Shotgun" 
SWEP.Type_Displayed             = "Mk. VI Protector"  
