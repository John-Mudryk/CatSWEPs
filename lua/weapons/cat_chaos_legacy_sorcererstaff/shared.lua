...
SWEP.WorldModel = "models/joazzz/weapons/chaos/sorcerer_staff.mdl"
...
SWEP.VElements = {
	["staff"] = { type = "Model", model = "models/joazzz/weapons/chaos/sorcerer_staff.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, -28.532), angle = Angle(0, -91.667, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1} }
}

SWEP.WElements = {
	["staff"] = { type = "Model", model = "models/joazzz/weapons/chaos/sorcerer_staff.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.466, -1.162, 44.618), angle = Angle(180, -180, -3.911), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1} }
}
    ...
    if CLIENT then
        if isBlocking then
            if not IsValid(self.ShieldModel) then
                ...
                self.ShieldModel:SetColor(Color(80, 0, 80, 255))
