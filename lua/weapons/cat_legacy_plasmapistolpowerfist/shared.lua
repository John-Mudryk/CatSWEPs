...
SWEP.PrintName				= "Plasma Pistol + Power Fist"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.PenetrationPower = 20
...
SWEP.Primary.IronAccuracy = 0.0002	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.IronSightsPos = Vector(-3.84, -5, 2.72)
SWEP.IronSightsAng = Vector(-0.077, -1.775, 0)
...
SWEP.SequenceTimeOverride = {
    ...
    [ACT_VM_RELOAD_EMPTY] = 5		-- Empty reload
}
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Mars Pattern Mk. I Sunfury + Mezoa Pattern Mk. I"
...
-- Attachments
SWEP.VElements = {
	["plasmapistol"] = { type = "Model", model = "models/joazzz/weapons/plasmapistol.mdl", bone = "weapon_bone", rel = "", pos = Vector(-7.449, 0, -5.79), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["powerfist"] = { type = "Model", model = "models/zadkiel/weapons/powerfist_regular_left.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.869, 2.253, 3.134), angle = Angle(13.229, -12.134, -83.211), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 7, bodygroup = {[2] = 6} },
}

SWEP.WElements = {
	["plasmapistol"] = { type = "Model", model = "models/joazzz/weapons/plasmapistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.407, 1.404, 2.141), angle = Angle(164.289, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["powerfist"] = { type = "Model", model = "models/zadkiel/weapons/powerfist_regular_left.mdl", bone = "ValveBiped.Anim_Attachment_LH", rel = "", pos = Vector(0, -3.208, 7.342), angle = Angle(91.936, 180, -1.101), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 7, bodygroup = {[2] = 6} },
}
...
if CLIENT then
	SWEP.VentViewmodelOffset = {
		pos = Vector(0, 0, -3), -- Up/down/forward/backward
