...
SWEP.VElements = {
	["flamer"] = { type = "Model", model = "models/joazzz/weapons/flamer.mdl", bone = "weapon_bone", rel = "", pos = Vector(0.814, 0.252, -1.759), angle = Angle(5.018, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 1} }
}
SWEP.WElements = {
	["flamer"] = { type = "Model", model = "models/joazzz/weapons/flamer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.232, 1.095, -3.968), angle = Angle(-12.252, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 1} }
}
