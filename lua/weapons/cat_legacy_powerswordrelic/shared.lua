...
SWEP.VElements = {
	["powersword"] = { type = "Model", model = "models/joazzz/weapons/powersword_regicide.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, 0.518, 15.5), angle = Angle(-3.507, -94.675, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 0, [2] = 3} }
}

SWEP.WElements = {
	["powersword"] = { type = "Model", model = "models/joazzz/weapons/powersword_regicide.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, -20), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 0, [2] = 3} },
}
