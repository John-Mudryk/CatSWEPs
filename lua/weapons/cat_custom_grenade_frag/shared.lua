...
SWEP.PrintName				= "Grenade - Fragmentation"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Launcher" 
SWEP.Type_Displayed             = "Interitus Mk. V" 

-- Attachments
SWEP.VElements = {
	["grenade"] = { type = "Model", model = "models/muschi/weapons/muschi_grenade_frak.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(0, 0.771, 1.223), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["grenade"] = { type = "Model", model = "models/muschi/weapons/muschi_grenade_frak.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.591, 2.733, 2.772), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Primary.Projectile = "cat_grenade_frag" -- What entity is to be spawned
SWEP.Primary.Round = "cat_grenade_frag" -- What entity is to be spawned
...
SWEP.Primary.Round = "cat_grenade_frag"
