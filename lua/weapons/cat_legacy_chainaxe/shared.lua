...
SWEP.WorldModel = "models/joazzz/weapons/chainaxe_curved.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("chainhit3.wav"), -- Sound ID
		["snd_delay"] = 0.26,
...
SWEP.Secondary.Attacks = {
	{
		...
		["snd"] = Sound("chainmiss3.wav"), -- Sound ID
		["snd_delay"] = 0.5,
		["viewpunch"] = Angle(5, 0, 0), --viewpunch angle
		["end"] = 1.2, --time before next attack
		["hull"] = 42, --Hullsize
...
SWEP.VElements = {
	["axe"] = { type = "Model", model = "models/joazzz/weapons/chainaxe_curved.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, -1.5, 15), angle = Angle(-3.507, 90, -0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}

SWEP.WElements = {
	["axe"] = { type = "Model", model = "models/joazzz/weapons/chainaxe_curved.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.5, 1.557, -15.5), angle = Angle(180, 0.169, 1.17), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}
SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Mk. II Assault"
