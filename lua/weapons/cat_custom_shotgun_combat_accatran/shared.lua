...
SWEP.PrintName				= "Accatran Combat Shotgun"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/muschi/weapons/muschi_swep_shotgun_v.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_shotgun.mdl"	-- Weapon world model
...
SWEP.Primary.Force = 2.5 -- Force value, leave nil to autocalc
SWEP.Primary.Knockback = 0.25 -- Autodetected if nil; this is the velocity kickback
...
SWEP.Primary.Sound			= "weapons/marsshotgun/fire.wav"		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-4.68, 0, 1.6)
SWEP.IronSightsAng = Vector(0.34, -1.701, 0)
...
SWEP.Type                       = "Shotgun" 
SWEP.Type_Displayed             = "Accatran Pattern Type XI Short" 

-- Attachments
SWEP.VElements = {
	["shotgun"] = { type = "Model", model = "models/joazzz/warhammer40k/weapons/shotgun_imperialguard.mdl", bone = "weapon_bone", rel = "", pos = Vector(-8.961, 0.704, -9.04), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 1} }
}

SWEP.WElements = {
	["shotgunW"] = { type = "Model", model = "models/joazzz/warhammer40k/weapons/shotgun_imperialguard.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.102, 1.032, 4.731), angle = Angle(-10.551, 0, 180), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

-- Define reload sound events
SWEP.EventTable = {
    [ACT_VM_RELOAD] = { -- Use the appropriate reload animation activity
        {time = 0.1, type = "sound", value = "weapons/m3/s3_insertshell.wav"}  -- Magazine in sound
    }
}
