...
SWEP.PrintName				= "Tigrus Combi-Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.401, -4.86, 1.669)
SWEP.IronSightsAng = Vector(-8.433, -1.823, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Tigrus Pattern Mk. Ic"

-- Attachments
SWEP.VElements = {
	["bolterTC"] = { type = "Model", model = "models/joazzz/weapons/bolter_combi_tigruspattern.mdl", bone = "weapon_bone", rel = "", pos = Vector(-5.532, 0.597, -9.504), angle = Angle(5.947, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["bolterTC"] = { type = "Model", model = "models/joazzz/weapons/bolter_combi_tigruspattern.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.529, 1.264, 7.441), angle = Angle(-12.771, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
