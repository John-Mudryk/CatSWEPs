...
SWEP.PrintName				= "Grenade - Smoke"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Launcher" 
SWEP.Type_Displayed             = "Occultare Mk. IX" 

-- Attachments
SWEP.VElements = {
	["grenade"] = { type = "Model", model = "models/muschi/weapons/muschi_grenade_smoke.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(0, 0.771, 1.223), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["grenade"] = { type = "Model", model = "models/muschi/weapons/muschi_grenade_smoke.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.591, 2.733, 2.772), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Primary.Projectile = "cat_grenade_smoke" -- What entity is to be spawned
SWEP.Primary.Round = "cat_grenade_smoke" -- What entity is to be spawned
...
-- Velocity Settings
SWEP.Velocity = 1250                  -- Overhand throw speed
SWEP.Velocity_Underhand = 600         -- Underhand throw speed
...
function SWEP:Think()
    ...
    elseif self:IsAttached("cat_nade_fuse_impact") then
        self.CookTimer = 1000 -- Disable timer since it's impact based
    else
