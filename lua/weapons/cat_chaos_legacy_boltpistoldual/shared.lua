...
SWEP.PrintName				= "Chaos Dual Bolt Pistols"		-- Weapon name (Shown on HUD)	
...
SWEP.VElements = {
	...
	["boltpistol_l"] = { type = "Model", model = "models/joazzz/weapons/chaos/boltpistol2.mdl", bone = "v_weapon.elite_left", rel = "", pos = Vector(0, -4, -0.75), angle = Angle(90, 0, -90), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 1, [4] = 1} },
	["boltpistol_r"] = { type = "Model", model = "models/joazzz/weapons/chaos/boltpistol2.mdl", bone = "v_weapon.elite_right", rel = "", pos = Vector(0, -4, -0.75), angle = Angle(90, 0, -90), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 1, [4] = 1} }
}

SWEP.WElements = {
	["meg_l"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_mag.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.355, 2.698, 5.282), angle = Angle(0, 169.264, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["boltpistol_l"] = { type = "Model", model = "models/joazzz/weapons/chaos/boltpistol2.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.316, 2.377, 5.967), angle = Angle(0, -13.282, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 1, [4] = 1} },
	["meg_r"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_mag.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.131, 3.904, -5.59), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["boltpistol_r"] = { type = "Model", model = "models/joazzz/weapons/chaos/boltpistol2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.197, 3.155, -5.934), angle = Angle(173.891, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 1} }
}
