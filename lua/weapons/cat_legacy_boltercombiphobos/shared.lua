...
SWEP.PrintName				= "Phobos Combi-Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.361, -4.86, 0.87)
SWEP.IronSightsAng = Vector(-5.961, -1.765, 0)
...
-- Attachments
SWEP.VElements = {
	["bolterPC"] = { type = "Model", model = "models/joazzz/weapons/bolter_combi_phobospattern.mdl", bone = "weapon_bone", rel = "", pos = Vector(-5.532, 0.597, -9.504), angle = Angle(5.947, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["bolterPC"] = { type = "Model", model = "models/joazzz/weapons/bolter_combi_phobospattern.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.529, 1.264, 7.441), angle = Angle(-12.771, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "cat_am_metalstorm", "cat_am_inferno", "cat_am_kraken", "cat_am_saw", "cat_am_stalker", "cat_am_hellfire", "cat_am_warp", "cat_am_psy"}, order = 3 },
