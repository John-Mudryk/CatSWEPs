...
SWEP.VElements = {
	["powerhalberd"] = { type = "Model", model = "models/joazzz/weapons/forceaxe.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.036, 0.079, 20.324), angle = Angle(0, -90, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 3, [1] = 3, [2] = 3, [3] = 1, [4] = 5} }
}

SWEP.WElements = {
	["powerhalberd"] = { type = "Model", model = "models/joazzz/weapons/forceaxe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4, 1.489, -28.969), angle = Angle(-166.67, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 3, [1] = 3, [2] = 3, [3] = 1, [4] = 5} }
}

SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Infernus Pattern Mk. IIId"
