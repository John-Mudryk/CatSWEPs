...
SWEP.PrintName				= "Lascarbine"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.257, -7.562, 3.555)
SWEP.IronSightsAng = Vector(-4.014, -1.691, 0)
...
SWEP.Type_Displayed             = "Kantreal Mk. V"
...
SWEP.WElements = {
	["laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(19.16, -0.59, -5.35), angle = Angle(-13.226, -1.963, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
