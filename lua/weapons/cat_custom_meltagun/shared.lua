...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(2.63, 3.036, -4.124), angle = Angle(0, 0, 0) }
}
...
SWEP.IronSightsPos = Vector(-5.057, -6.09, 1.455)
SWEP.IronSightsAng = Vector(-6.033, -1.596, -4.108)
...
SWEP.Type                       = "Shotgun" 
SWEP.Type_Displayed             = "Accatran Pattern Mk. IX"
