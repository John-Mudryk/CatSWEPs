...
SWEP.PrintName				= "Heavy Bolter Astartes"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-3.832, 9.053, 12.201), angle = Angle(0, 0, 0) }
}


SWEP.Primary.Sound			= "40k/b_fire6.wav"		-- script that calls the primary fire sound
SWEP.Primary.RPM			= 580		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
SWEP.Type_Displayed             = "Lucius Pattern Mk. XLIX"  
...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_stationare_heavy_bolter.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(29.733, 0.628, 0), angle = Angle(167.332, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
