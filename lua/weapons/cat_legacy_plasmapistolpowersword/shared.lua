...
SWEP.PrintName				= "Plasma Pistol + Power Sword"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Mars Pattern Mk. I Sunfury + Proteus Pattern Mk. IIa"
...
SWEP.VElements = {
	...
	["powersword"] = { type = "Model", model = "models/joazzz/weapons/powersword.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(2.016, 0.538, 6.512), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 3, [2] = 18} },
}
...
SWEP.WElements = {
	...
	["powersword"] = { type = "Model", model = "models/joazzz/weapons/powersword.mdl", bone = "ValveBiped.Anim_Attachment_LH", rel = "", pos = Vector(-0.484, -4.6, 3.592), angle = Angle(47.118, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 3, [2] = 18} }
}
