...
-- Attachments
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/chaos/heavyweapon_heavybolter.mdl", bone = "weapon_bone", rel = "", pos = Vector(2.197, 1.008, -3.126), angle = Angle(8.892, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/chaos/heavyweapon_heavybolter.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(19.051, 1.75, -3.322), angle = Angle(-165.984, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
