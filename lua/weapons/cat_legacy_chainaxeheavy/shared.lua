...
SWEP.PrintName = "Heavy Chain Axe"
...
SWEP.WorldModel = "models/joazzz/weapons/chainaxe_heavy.mdl"
...
SWEP.VElements = {
	["axe"] = { type = "Model", model = "models/joazzz/weapons/chainaxe_heavy.mdl", bone = "RW_Weapon", rel = "", pos = Vector(10.036, 0.079, 25.324), angle = Angle(0, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 1, [3] = 1} }
}

SWEP.WElements = {
	["axe"] = { type = "Model", model = "models/joazzz/weapons/chainaxe_heavy.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(21.555, 9.489, -22.969), angle = Angle(-166.67, -13.167, 7.964), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 1, [3] = 1} }
}
