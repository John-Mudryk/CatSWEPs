...
SWEP.PrintName				= "Tigrus Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.DefaultClip		= 125	                -- Default number of bullets in a clip
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Tigrus Pattern Mk. II"
