...
SWEP.PrintName				= "Terminator Stormbolter"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.KickDown			= .075		-- Maximum down recoil (skeet)
...
SWEP.IronSightsPos = Vector(-4.16, 0, 2.079)
SWEP.IronSightsAng = Vector(-5.461, -1.912, 0.939)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Mars Pattern Mk. Ia" 
...
SWEP.WElements = {
	["stormbolterT"] = { type = "Model", model = "models/joazzz/weapons/stormbolter_terminator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.512, 2.25, -2.356), angle = Angle(-102.205, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 2} }
}
