...
SWEP.PrintName				= "Plasma Exterminator"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0.873, -2.31, 3.756), angle = Angle(0, 0, 0) },
...
SWEP.IronSightsPos = Vector(-4.52, -3, 1.159)
SWEP.IronSightsAng = Vector(-3.08, -1.698, 0)
...
-- Attachments
SWEP.VElements = {
	["plasmaexterminator"] = { type = "Model", model = "models/zadkiel/weapons/primaris_plasmaexterminator.mdl", bone = "weapon_bone", rel = "", pos = Vector(-2.393, 0.72, -2.892), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["plasmaexterminator"] = { type = "Model", model = "models/zadkiel/weapons/primaris_plasmaexterminator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.326, 2.082, -1.66), angle = Angle(-174.15, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
