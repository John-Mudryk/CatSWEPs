...
SWEP.PrintName				= "Phobos Bolt Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-3.681, -5.9, -2.8)
SWEP.IronSightsAng = Vector(5.448, -0.013, 0)
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Phobos Pattern Mk. Ib"
...
SWEP.WElements = {
	["boltpistolP"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_phobospattern.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.592, 0.765, -3.31), angle = Angle(169.031, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
