...
SWEP.PrintName				= "Laspistol"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.DefaultClip		= 250	                -- Default number of bullets in a clip
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Kantreal Mk. II"
...
SWEP.WElements = {
	["laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.005, -1.26, -4.157), angle = Angle(-11.275, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
...
SWEP.IronSightsAng_Reflex = Vector(-1.221, 1.256, 0)

SWEP.IronSightsPos_Light = Vector(-3.141, -5, -0.76)
SWEP.IronSightsAng_Light = Vector(-2.271, 2.05, 0)