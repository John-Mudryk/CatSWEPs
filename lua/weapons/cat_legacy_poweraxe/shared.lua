...
SWEP.WorldModel = "models/joazzz/weapons/poweraxe.mdl"
...
SWEP.VElements = {
	["poweraxe"] = { type = "Model", model = "models/joazzz/weapons/poweraxe.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.036, 0.079, 15.324), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 5, [1] = 3, [2] = 1, [4] = 2} }
}

SWEP.WElements = {
	["poweraxe"] = { type = "Model", model = "models/joazzz/weapons/poweraxe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 1.489, -11.969), angle = Angle(-166.67, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 5, [1] = 3, [2] = 1, [4] = 2} }
}

SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Mars-Proteus Pattern Mk. II"
