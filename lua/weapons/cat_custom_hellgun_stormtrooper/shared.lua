...
SWEP.Primary.RPM			= 540		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
SWEP.IronSightsPos = Vector(-3.891, -8.377, 2.599)
SWEP.IronSightsAng = Vector(-0.415, -1.369, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Mk. 2 Gyro-stabilised"
...
SWEP.Attachments = {
    	...
    	[2] = { offset = { 0, 0 }, atts = { "cat_flashlight", "cat_lasersight"}, order = 2 },
