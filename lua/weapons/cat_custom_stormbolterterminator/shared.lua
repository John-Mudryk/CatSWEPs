...
SWEP.PrintName				= "Stormbolter Terminator"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-3.481, -5.593, 1.539)
SWEP.IronSightsAng = Vector(-2.771, -0.756, 0)
...
SWEP.Type_Displayed             = "Mk. IVd Blastlight" 
