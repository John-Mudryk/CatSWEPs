...
SWEP.PrintName				= "Autopistol"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/muschi/weapons/muschi_swep_autopistol_v.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_autopistol.mdl"	-- Weapon world model
SWEP.ViewModelFlip                      = false
...
SWEP.Primary.PenetrationPower = 2
...
SWEP.Blowback_Shell_Effect = "PistolShellEject"
...
SWEP.IronSightsPos = Vector(-3.12, -5.256, -0.589)
SWEP.IronSightsAng = Vector(-0.35, 0.349, -0)
...
SWEP.LuaShellEffect = "PistolShellEject" --Defaults to blowback

SWEP.Type                       = "Machine Pistol"
SWEP.Type_Displayed             = "Agripinaa Pattern Mk. X"

-- Attachments
SWEP.VElements = {
	["scope_reflex"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "tag_weapon", rel = "", pos = Vector(4, -0.101, 6.199), angle = Angle(-90, -90, 90), size = Vector(0.025, 0.025, 0.025), color = Color(255, 255, 255, 255), surpresslightning = false, material = "entities/scope_reflex_reticle", skin = 0, bodygroup = {}, active = false },
	["scope_short"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "tag_weapon", rel = "", pos = Vector(2, -0.16, 5.949), angle = Angle(-90, -90, 90), size = Vector(0.025, 0.025, 0.025), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },


	["laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "tag_weapon", rel = "", pos = Vector(6.697, -1.502, 3.164), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}

SWEP.WElements = {
	["laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.368, 2.782, -5.553), angle = Angle(-12.356, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
...
SWEP.EventTable = {
    [ACT_VM_RELOAD] = { -- Use the appropriate reload animation activity
        ...
        {time = 2, type = "sound", value = "weapons/magin.wav"}  -- Magazine in sound
    },
	[ACT_VM_RELOAD_EMPTY] = {
        {time = 0.5, type = "sound", value = "weapons/magout.wav"}, -- Magazine out sound
        {time = 2, type = "sound", value = "weapons/magin.wav"},  -- Magazine in sound
...
SWEP.Attachments = {
	[1] = { offset = { 0, 0 }, atts = { "cat_am_ap", "cat_am_match", "cat_am_magnum", "cat_am_incendiary"}, order = 1 },
    	[2] = { offset = { 0, 0 }, atts = { "cat_mag_extend_three"}, order = 2 },
	[3] = { offset = { 0, 0 }, atts = {"cat_scope_reflex", "cat_scope_dot", "cat_scope_reflex_hud", "cat_scope_dot_hud"}, order = 3 },
    	...
    	[5] = { offset = { 0, 0 }, atts = { "cat_bar_suppressor"}, order = 5 },
...
SWEP.IronSightsPos_Reflex = Vector(-3.12, -5, -0.601)
SWEP.IronSightsAng_Reflex = Vector(-2.695, 0.584, 0)

SWEP.IronSightsPos_Short = Vector(-3.142, -9, -0.608)
SWEP.IronSightsAng_Short = Vector(-3.103, 0.275, 0)