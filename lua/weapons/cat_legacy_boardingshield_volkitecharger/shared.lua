...
SWEP.PrintName				= "Volkite Charger + Heresy Boarding Shield"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Shotgun" 
SWEP.Type_Displayed             = " Mars-Omega Pattern Mk. Ib + Atticus Pattern Mk. I"

-- Attachments
SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/joazzz/weapons/volkite_charger.mdl", bone = "weapon_bone", rel = "", pos = Vector(3.309, 1.636, -0.715), angle = Angle(5.594, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	["gunW"] = { type = "Model", model = "models/joazzz/weapons/volkite_charger.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.906, 1.44, -3.398), angle = Angle(-13.65, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["shield"] = { type = "Model", model = "models/joazzz/weapons/w_shield.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(4.883, -10.921, 5.108), angle = Angle(86.148, 165.11, -77.848), size = Vector(0.782, 0.782, 0.782), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 24} }
