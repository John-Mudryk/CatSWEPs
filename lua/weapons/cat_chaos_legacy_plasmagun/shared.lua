...
-- Attachments
SWEP.VElements = {
	["plasmagunCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/plasmagun.mdl", bone = "weapon_bone", rel = "", pos = Vector(-7.178, 0.347, 0.508), angle = Angle(2.674, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["plasmagunCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/plasmagun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.992, 1.169, -4.56), angle = Angle(-12.898, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
