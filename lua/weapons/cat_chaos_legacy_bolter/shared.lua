...
SWEP.PrintName				= "Chaos Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.281, -6.72, 0.519)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Umbra Pattern Mk. I"

-- Attachments
SWEP.VElements = {
	["bolterCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/bolter.mdl", bone = "weapon_bone", rel = "", pos = Vector(3.635, 0.547, -2.392), angle = Angle(3.282, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 3, [2] = 3, [3] = 5, [5] = 3, [6] = 1, [7] = 2}, [8] = 1 },
	["mag"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_curve.mdl", bone = "mag_bone", rel = "", pos = Vector(5.969, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true },
	["mag2"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_box.mdl", bone = "mag_bone", rel = "", pos = Vector(5.969, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },

	["scope_heavy"] = { type = "Model", model = "models/rtcircle.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "bolterCH", pos = Vector(-8.091, 0, 9.267), angle = Angle(0, -180, 0), size = Vector(0.763, 0.763, 0.763), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },
...
SWEP.WElements = {
	["bolterCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/bolter.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.102, 1.71, -2.206), angle = Angle(-13.002, -1.818, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 3, [2] = 3, [3] = 5, [5] = 3, [6] = 1, [7] = 2}, [8] = 1 },
	["mag"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_curve.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.404, 1.848, -2.191), angle = Angle(-13.948, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true },
	["mag2"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_box.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.404, 1.848, -2.191), angle = Angle(-13.948, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
}
...
SWEP.Attachments = {
	...
	[3] = { offset = { 0, 0 }, atts = { "cat_scope_heavy2", "cat_scope_heavy2_hud", "cat_scope_astartes"}, order = 3 },
...
SWEP.IronSightsPos_Heavy = Vector(-4.321, -5, 1.679)
SWEP.IronSightsAng_Heavy = Vector(-12.278, -1.8, 0)