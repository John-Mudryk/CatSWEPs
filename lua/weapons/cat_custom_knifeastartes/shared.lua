...
SWEP.PrintName = "Combat Knife Astartes"
...
SWEP.WorldModel = "models/muschi/weapons/muschi_swep_knife_astartes.mdl"
SWEP.HoldType = "knife"
...
SWEP.WElements = {
	["sword"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_knife_astartes.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, -3), angle = Angle(90, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {} },
}
