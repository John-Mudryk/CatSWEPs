...
SWEP.PrintName				= "Multi-laser"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.ClipSize			= 2500		-- Size of a clip
SWEP.Primary.DefaultClip		= 2500	                -- Default number of bullets in a clip
...
SWEP.BlowbackVector = Vector(0, -0.125, 0.00) --Vector to move bone <or root> relative to bone <or view> orientation.
...
-- Tracer Stuff
SWEP.TracerName		 = "tracer_laser_big_cat"   -- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
SWEP.Type_Displayed             = "Fortis Pattern Mk. II"
...
SWEP.IronSightsAng_Short = Vector(-4.533, -1.624, 0)
