...
SWEP.ViewModel				= "models/muschi/weapons/muschi_swep_longlas_v.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_longlas.mdl"	-- Weapon world model
SWEP.ViewModelFlip                      = false
...
SWEP.Primary.PenetrationPower = 12
...
SWEP.IronSightsPos = Vector(-4.308, -9.528, 3.391)
SWEP.IronSightsAng = Vector(-4.381, -1.366, -2.053)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Kantreal Mk. XXI"
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "cat_scope_heavy", "cat_scope_light"}, order = 2 },
