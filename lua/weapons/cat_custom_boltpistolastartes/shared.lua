...
SWEP.PrintName				= "Bolt Pistol Astartes"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Hesh Pattern Mk. IIIa"
...
-- Attachments
SWEP.VElements = {
	["laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "tag_weapon", rel = "", pos = Vector(6.309, 1.799, 2.243), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "cat_am_metalstorm", "cat_am_inferno", "cat_am_kraken", "cat_am_saw", "cat_am_stalker", "cat_am_hellfire", "cat_am_warp", "cat_am_psy"}, order = 2 },
    	...
    	[6] = { offset = { 0, 0 }, atts = { "cat_vent"}, order = 6 },
