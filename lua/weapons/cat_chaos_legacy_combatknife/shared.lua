...
SWEP.PrintName = "Chaos Combat Knife"
...
SWEP.WorldModel = "models/joazzz/weapons/chaos/combatknife.mdl"
SWEP.HoldType = "knife"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("pulv_swing_light2.wav"), -- Sound ID
		["snd_delay"] = 0.26,
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/chaos/combatknife.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, -0.518, 2.596), angle = Angle(-90, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 17, [2] = 4} }
}

SWEP.WElements = {
	["sword"] = { type = "Model", model = "models/joazzz/weapons/chaos/combatknife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, -3), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
