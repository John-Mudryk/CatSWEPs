...
SWEP.PrintName				= "Plasma Cannon"		-- Weapon name (Shown on HUD)	
...
-- Tracer Stuff
SWEP.TracerName		 = "tracer_laser_big_plasma"   -- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
-- Attachments
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/devastator_weapon_nocable.mdl", bone = "weapon_bone", rel = "", pos = Vector(34.481, -19.536, -22.81), angle = Angle(75.973, 2.697, 1.169), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/devastator_weapon_nocable.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(45.669, 24.944, 11.786), angle = Angle(-96.693, -174.211, 7.175), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 1} }
}
