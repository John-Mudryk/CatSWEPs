...
SWEP.PrintName				= "Chaos Bolt Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-3.881, -5.9, -2.441)
SWEP.IronSightsAng = Vector(-0.442, -0.08, 0)
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Godwyn Pattern Mk. III"
...
-- Attachments
SWEP.VElements = {
	["mag"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_mag.mdl", bone = "tag_clip", rel = "", pos = Vector(0.46, 0.409, 1.883), angle = Angle(0, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["boltpistolCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/boltpistol2.mdl", bone = "tag_weapon", rel = "", pos = Vector(0.916, 0.55, 4.81), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 1, [3] = 1} }
}
