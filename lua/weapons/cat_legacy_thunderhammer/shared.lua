...
SWEP.WorldModel = "models/joazzz/weapons/thunderhammer.mdl"
...
SWEP.VElements = {
	["thunderhammer"] = { type = "Model", model = "models/joazzz/weapons/thunderhammer.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.4, 0, 5.6), angle = Angle(0, 180, 90), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 2, [1] = 3}}
}
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Crucis Pattern Mk. III" 
