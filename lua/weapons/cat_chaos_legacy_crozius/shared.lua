...
SWEP.PrintName = "Accursed Crozius"
SWEP.Author				= "The Cat"
SWEP.Type = ""
...
SWEP.WorldModel = "models/joazzz/weapons/chaos/powermace_accursedcrozius.mdl"
...
function SWEP:ChoosePrimaryAttack()
    ...
    if attack then
        attack.dmg = self:GetStat("Primary.Damage") -- Force damage update to be dynamic
...
function SWEP:ChooseSecondaryAttack()
    ...
    if attack then
        attack.dmg = self:GetStat("Primary.Damage") * 1.25 -- Force damage update for secondary attacks to be dynamic
