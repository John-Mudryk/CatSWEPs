...
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_bazooka.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3, 2, 3), angle = Angle(170, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "" }
}
...
SWEP.RiotShieldCone = 15 -- Default blocking angle
SWEP.RiotShieldConeADS = 20 -- Reduced block angle when ADS
