...
SWEP.PrintName				= "Umbra Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.29, -5.519, 0.899)
SWEP.IronSightsAng = Vector(-6.148, -1.805, 0)
...
-- Attachments
SWEP.VElements = {
	["bolterU"] = { type = "Model", model = "models/joazzz/weapons/bolter_umbrapattern.mdl", bone = "weapon_bone", rel = "", pos = Vector(-4.25, 0.521, -10.377), angle = Angle(5.947, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 5} },
	["mag"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_curve.mdl", bone = "mag_bone", rel = "", pos = Vector(3.303, 0.479, -0.171), angle = Angle(3.974, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["mag2"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_box.mdl", bone = "mag_bone", rel = "", pos = Vector(3.299, 0.5, 0.28), angle = Angle(4, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },

	["scope_light"] = { type = "Model", model = "models/rtcircle.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "bolterU", pos = Vector(-6.62, 0.004, 17.641), angle = Angle(-15, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },
	["scope_heavy"] = { type = "Model", model = "models/rtcircle.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "bolterU", pos = Vector(-9.761, 0.004, 17.641), angle = Angle(-8, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },

}


SWEP.WElements = {
	["bolterU"] = { type = "Model", model = "models/joazzz/weapons/bolter_umbrapattern.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.102, 1.71, 6.206), angle = Angle(-13.002, -1.818, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.IronSightsAng_Light = Vector(-6.884, -1.24, 0)

SWEP.IronSightsPos_Heavy = Vector(-4.361, 0, 0.159)
SWEP.IronSightsAng_Heavy = Vector(-7.423, -0.982, 0)