...
SWEP.VElements = {
	["powerswordCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/sword_powersword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, -0.518, 5.5), angle = Angle(-3.507, -90.675, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 16, bodygroup = {[1] = 0, [2] = 0} }
}

SWEP.WElements = {
	["powerswordCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/sword_powersword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, -7), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 16, bodygroup = {[1] = 0, [2] = 0} },
}
...
SWEP.Attachments = {
	...
	[2] = { offset = { 0, 0 }, atts = { "cat_skin_powersword_chaos"}, order = 2 },
