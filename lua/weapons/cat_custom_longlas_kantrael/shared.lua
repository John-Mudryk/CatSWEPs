...
SWEP.PrintName				= "Kantrael Longlas"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-3.931, -8.306, 4.144)
SWEP.IronSightsAng = Vector(-3.201, -1.726, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Kantreal Mk. IVa"
...
SWEP.VElements = {
	...
	["longlasK"] = { type = "Model", model = "models/bloocobalt/dow/fallout/weapons/lasgun.mdl", bone = "weapon_bone", rel = "", pos = Vector(5, 0.541, -2.837), angle = Angle(-3.211, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [3] = 2, [4] = 1} },
	...
	["scope_short"] = { type = "Model", model = "models/rtcircle.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "longlasK", pos = Vector(12.845, 0.34, 7.132), angle = Angle(0, 0, 0), size = Vector(0.349, 0.349, 0.349), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },
	["scope_light"] = { type = "Model", model = "models/rtcircle.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "longlasK", pos = Vector(12.845, 0.34, 7.132), angle = Angle(0, 0, 0), size = Vector(0.349, 0.349, 0.349), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },
}

SWEP.WElements = {
	["longlasKW"] = { type = "Model", model = "models/bloocobalt/dow/fallout/weapons/lasgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.993, 0.597, -2.577), angle = Angle(166.645, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[3] = 2, [4] = 1} }
}
...
SWEP.IronSightsPos_Short = Vector(-3.921, -7, 2.9)
SWEP.IronSightsAng_Short = Vector(-7.968, -1.548, 0)

SWEP.IronSightsPos_Light = Vector(-3.921, -8, 2.9)
SWEP.IronSightsAng_Light = Vector(-9.416, -1.822, 0)