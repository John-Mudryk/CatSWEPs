...
-- Attachments
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/chaos/plasmapistol.mdl", bone = "tag_weapon", rel = "", pos = Vector(2.96, 0, -0.167), angle = Angle(-2.274, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/chaos/plasmapistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.536, 1.503, -1.568), angle = Angle(166.798, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
