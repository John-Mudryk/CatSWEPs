...
SWEP.PrintName				= "Chaos Legion Plasma Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-3.36, 0, -0.201)
SWEP.IronSightsAng = Vector(-2.879, -0.417, 0)
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Mars Pattern Mk. I Sunfury"
...
-- Attachments
SWEP.VElements = {
	["plasmapistolCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/plasmapistol.mdl", bone = "tag_weapon", rel = "", pos = Vector(2.96, 0, -0.167), angle = Angle(-2.274, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["plasmacannonCH"] = { type = "Model", model = "models/joazzz/weapons/chaos/plasmapistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.536, 1.503, -1.568), angle = Angle(166.798, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
