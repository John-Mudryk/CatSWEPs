...
SWEP.PrintName				= "Chaos Legion Meltagun"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-5.321, 0, -0.657)
SWEP.IronSightsAng = Vector(4.254, -1.923, 0)
...
SWEP.Type                       = "Shotgun" 
SWEP.Type_Displayed             = "Vulkan Pattern Mk. II"
