...
SWEP.PrintName = "Aquilan Chainsword"
...
SWEP.WorldModel = "models/joazzz/weapons/chainsword.mdl"
...
SWEP.VElements = {
	["sword"] = { type = "Model", model = "models/joazzz/weapons/chainsword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, 0.518, -2.596), angle = Angle(-3.507, -180, -0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 1} }
}

SWEP.WElements = {
	["sword"] = { type = "Model", model = "models/joazzz/weapons/chainsword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.557, 1.947), angle = Angle(180, -90.169, -1.17), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 1} }
}
SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Aquilan Pattern Mk. III"
