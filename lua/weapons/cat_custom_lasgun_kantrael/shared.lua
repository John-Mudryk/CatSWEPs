...
SWEP.PrintName				= "Lasgun Kantrael"		-- Weapon name (Shown on HUD)	
...
-- Attachments
SWEP.VElements = {
	["lasgunK"] = { type = "Model", model = "models/bloocobalt/dow/fallout/weapons/lasgun.mdl", bone = "weapon_bone", rel = "", pos = Vector(5, 0.541, -2.837), angle = Angle(-3.211, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[4] = 1} }
}
