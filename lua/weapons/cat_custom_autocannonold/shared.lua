...
SWEP.PrintName				= "Autocannon Old"		-- Weapon name (Shown on HUD)	
...
-- Attachments
SWEP.VElements = {
	["sight"] = { type = "Model", model = "models/wystan/attachments_tfa/eotech557sight.mdl", bone = "weapon_bone", rel = "", pos = Vector(-5.002, -0.815, 1.055), angle = Angle(11.189, 0, 0), size = Vector(0.885, 0.885, 0.885), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
