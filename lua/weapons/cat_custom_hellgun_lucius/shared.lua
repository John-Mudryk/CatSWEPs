...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Lucius Pattern Type XIV Heavy"
...
SWEP.WElements = {
	["luciusHW"] = { type = "Model", model = "models/gutsy/warhammer40k/weapons/luciuslasgungrenadier.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.85, 0.723, -4.033), angle = Angle(169.481, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 1} }
}
