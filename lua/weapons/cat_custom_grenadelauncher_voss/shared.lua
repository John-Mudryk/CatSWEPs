...
SWEP.PrintName				= "Grenade Launcher Voss"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.281, -7.862, 4.794)
SWEP.IronSightsAng = Vector(-17.073, -1.793, 0)
...
SWEP.Type                       = "Launcher" 
SWEP.Type_Displayed             = "Voss Pattern MK. I" 

-- Attachments
SWEP.VElements = {
	["glauncher"] = { type = "Model", model = "models/gutsy/warhammer40k/weapons/grenadelauncher.mdl", bone = "weapon_bone", rel = "", pos = Vector(0.354, 0.479, -1.652), angle = Angle(-6.863, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 2, [1] = 1, [2] = 2} }
}

SWEP.WElements = {
	["glauncherW"] = { type = "Model", model = "models/gutsy/warhammer40k/weapons/grenadelauncher.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.743, 1.44, -3.626), angle = Angle(167.843, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 2, [1] = 1, [2] = 2} }
}
	...
	if IsFirstTimePredicted() then
		...
		-- create the designated grenade type
			...
			entity:Spawn()
                        ...
                        entity:GetPhysicsObject():SetVelocityInstantaneous( dir * 9000 )
		end
		return
	end
