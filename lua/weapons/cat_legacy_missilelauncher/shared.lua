...
-- Attachments
SWEP.VElements = {
	["missilelauncher"] = { type = "Model", model = "models/joazzz/weapons/missilelauncher.mdl", bone = "weapon_bone", rel = "", pos = Vector(-18.333, 0.76, 2.677), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
