...
SWEP.PrintName				= "Umbra Mk. II Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Umbra Pattern Mk. II"
...
SWEP.WElements = {
	["bolterU2"] = { type = "Model", model = "models/joazzz/weapons/bolter_umbrapattern_mk2.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(10.102, 1.71, 6.206), angle = Angle(-13.002, -1.818, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
