...
SWEP.WorldModel = "models/joazzz/weapons/chainsword_long.mdl"
...
SWEP.VElements = {
	["chainsword"] = { type = "Model", model = "models/joazzz/weapons/chainsword_long.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, -1.5, 6), angle = Angle(-3.507, 90, -0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}

SWEP.WElements = {
	["chainsword"] = { type = "Model", model = "models/joazzz/weapons/chainsword_long.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.5, 1.557, -6.5), angle = Angle(180, 0.169, 1.17), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}
SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Mk. II Hell's Teeth"
