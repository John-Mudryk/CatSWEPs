...
SWEP.PrintName				= "Phobos Dual Bolt Pistols"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 560		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Phobos Pattern Mk. Ib + Phobos Pattern Mk. Ib"
...
-- Attachments
SWEP.VElements = {
	["mag_l"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_mag.mdl", bone = "v_weapon.magazine_left", rel = "", pos = Vector(0, -9, 0), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["mag_r"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_mag.mdl", bone = "v_weapon.magazine_right", rel = "", pos = Vector(0, -9, 0), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["boltpistol_l"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_phobospattern.mdl", bone = "v_weapon.elite_left", rel = "", pos = Vector(0.2, 0.25, 5.25), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} },
	["boltpistol_r"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_phobospattern.mdl", bone = "v_weapon.elite_right", rel = "", pos = Vector(-0.201, 0.25, 5.25), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}

SWEP.WElements = {
	["boltpistol_l"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_phobospattern.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(10.112, 3.022, 1.008), angle = Angle(0, 166.994, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["boltpistol_r"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_phobospattern.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.744, 2.082, -1.935), angle = Angle(173.891, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ViewModelBoneMods_Iron = {
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-4.5, -5.5, -1.5), angle = Angle(45, 0, 0) },
	["v_weapon.magazine_right"] = { scale = Vector(0.109, 0.109, 0.109), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-4.413, -4.584, 1.5), angle = Angle(-45, 0, 0) },
	["v_weapon.elite_right"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 2.2, 2.399), angle = Angle(0, -45, 0) },
	["v_weapon.magazine_left"] = { scale = Vector(0.109, 0.109, 0.109), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.elite_left"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, -1.859, 2.863), angle = Angle(0, 45, 0) }
}
