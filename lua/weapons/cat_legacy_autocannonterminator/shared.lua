...
SWEP.PrintName				= "Terminator Autocannon"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(4.387, 6.504, -2.464), angle = Angle(-0.069, -1.632, -11.613) },
...
SWEP.Type                       = "Launcher" 
SWEP.Type_Displayed             = "Cthon Pattern Reaper Mk. I"

-- Attachments
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/terminator_autocannon.mdl", bone = "weapon_bone", rel = "", pos = Vector(-5.053, 3.73, 0.409), angle = Angle(6.688, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["autocannonW"] = { type = "Model", model = "models/joazzz/weapons/terminator_autocannon.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, 0), angle = Angle(-13.249, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}
