...
SWEP.PrintName				= "Stalker Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.6, 0, -1.28)
SWEP.IronSightsAng = Vector(-7.422, -1.739, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Godwyn Pattern Mk. IIIb"
...
SWEP.WElements = {
	["stalkerbolter"] = { type = "Model", model = "models/joazzz/weapons/bolter_stalkerbolter.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.913, 1.282, -6.579), angle = Angle(180, -90, 13.592), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 9, bodygroup = {[1] = 2, [2] = 4} }
}
...
SWEP.IronSightsAng_Heavy = Vector(-4.653, -1.775, 0)