...
SWEP.PrintName = "Chaos Heresy Chain Axe"
...
SWEP.WorldModel = "models/joazzz/weapons/chainaxe_heresy.mdl"
...
SWEP.VElements = {
	["axeCH"] = { type = "Model", model = "models/joazzz/weapons/chainaxe_heresy.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, 9, 15), angle = Angle(-3.507, 90, -0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 8, bodygroup = {[0] = 1, [1] = 1, [2] = 1} }
}

SWEP.WElements = {
	["axeCH"] = { type = "Model", model = "models/joazzz/weapons/chainaxe_heresy.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(17, 1.557, -15.5), angle = Angle(180, 0.169, 1.17), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 8, bodygroup = {[0] = 1, [1] = 1, [2] = 1} }
}
