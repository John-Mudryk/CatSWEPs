...
SWEP.WorldModel = "models/muschi/weapons/muschi_swep_chaonsword_evecerator.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("chainhit2.wav"), -- Sound ID
		["snd_delay"] = 0.26,
...
SWEP.Secondary.Attacks = {
	{
		...
		["snd"] = Sound("chainmiss2.wav"), -- Sound ID
		["snd_delay"] = 0.5,
		["viewpunch"] = Angle(5, 0, 0), --viewpunch angle
		["end"] = 1.2, --time before next attack
		["hull"] = 42, --Hullsize
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_chaonsword_evecerator.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, -1.5, 5), angle = Angle(-3.507, -180, -0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 1} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_chaonsword_evecerator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.5, 1.557, -7), angle = Angle(180, -90.169, -1.17), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}
SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Tigrus Mk. IX Heavy"
