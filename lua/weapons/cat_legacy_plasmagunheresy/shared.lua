...
SWEP.PrintName				= "Heresy Plasma Gun"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsAng = Vector(-1.999, -1.734, 0)
...
-- Attachments
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/plasmagun_heresy.mdl", bone = "weapon_bone", rel = "", pos = Vector(-7.178, 0.347, -1.808), angle = Angle(2.674, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/plasmagun_heresy.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.992, 1.169, -1.16), angle = Angle(-12.898, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
