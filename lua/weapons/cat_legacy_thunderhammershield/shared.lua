...
SWEP.PrintName = "Thunder Hammer + Storm Shield"
...
SWEP.WorldModel = "models/zadkiel/w_shield.mdl"
SWEP.HoldType = "melee"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("weapons/zweihander/swing_hard_2.wav"), -- Sound ID
		["snd_delay"] = 0.26,
		["viewpunch"] = Angle(1, -5, 0), --viewpunch angle
		["end"] = 0.8, --time before next attack
		["hull"] = 42, --Hullsize
		["direction"] = "R", --Swing dir,
		["hitflesh"] = Sound("spl_shock_hit.wav"),
		["hitworld"] = Sound("gb_sfx/sndbreakdoor.wav"),
	},
	{
		...
		["hitflesh"] = Sound("weapons/zweihander/hitflesh_1.wav"),
...
SWEP.Secondary.Attacks = {
	{
		...
		["delay"] = 0.6, --Delay
		["spr"] = true, --Allow attack while sprinting?
		["snd"] = Sound("weapons/zweihander/swing_hard_4.wav"), -- Sound ID
		["snd_delay"] = 0.5,
		["viewpunch"] = Angle(5, 0, 0), --viewpunch angle
...
SWEP.ViewModelBoneMods = {
	...
	["LeftHandPinky1_1stP"] = { scale = Vector(0, 0, 0), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}

SWEP.VElements = {
	["shield"] = { type = "Model", model = "models/zadkiel/w_shield.mdl", bone = "LeftForeArm_1stP", rel = "", pos = Vector(3.053, -7, -15.449), angle = Angle(2.253, 94.565, 0), size = Vector(0.75, 0.75, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 21} },
	["thunderhammer"] = { type = "Model", model = "models/joazzz/weapons/thunderhammer_terminator.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.345, 0.211, -6.371), angle = Angle(0, 180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 2, [4] = 1} }
}

SWEP.WElements = {
	["shield"] = { type = "Model", model = "models/zadkiel/w_shield.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(3.253, -18.933, -4.876), angle = Angle(52.659, 95.986, 0), size = Vector(0.85, 0.85, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[0] = 21} },
	["thunderhammer"] = { type = "Model", model = "models/joazzz/weapons/thunderhammer_terminator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.635, 1.957, 12.121), angle = Angle(0, 180, 180), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 2, [4] = 1} }
}

SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Proteus Pattern Mk. II + Deliverance Pattern Mk. I"
