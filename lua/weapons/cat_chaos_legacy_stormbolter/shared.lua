...
SWEP.PrintName				= "Chaos Stormbolter"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= "40k/b_fire"..math.random(1, 6)..".wav"		-- script that calls the primary fire sound
...
-- Attachments
SWEP.VElements = {
	["stormbolter"] = { type = "Model", model = "models/joazzz/weapons/chaos/bolter_twinlinked.mdl", bone = "weapon_bone", rel = "", pos = Vector(1.014, 0.093, -3.3), angle = Angle(0, 180, 0), size = Vector(0.65, 0.65, 0.65), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 1} }
}

SWEP.WElements = {
	["stormbolter"] = { type = "Model", model = "models/joazzz/weapons/chaos/bolter_twinlinked.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.512, 2.25, -2.356), angle = Angle(-182.205, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 1} }
}
