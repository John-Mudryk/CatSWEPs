...
SWEP.PrintName = "Chaos Power Fist"
...
SWEP.VElements = {
	["powerfistC"] = { type = "Model", model = "models/joazzz/chaos/chaosmarines/powerfist_r.mdl", bone = "ValveBiped.Bip01_R_Ulna", rel = "", pos = Vector(10.142, -1.759, 4.235), angle = Angle(17.291, -5.305, 80.897), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 4, bodygroup = {[2] = 5, [3] = 3, [4] = 1} }
}

SWEP.WElements = {
	["powerfistC"] = { type = "Model", model = "models/joazzz/chaos/chaosmarines/powerfist_terminator_r.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.821, 5.846, -3.633), angle = Angle(-3.659, -31.937, -91.435), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 4, bodygroup = {[2] = 5, [3] = 3, [4] = 1} }
}
