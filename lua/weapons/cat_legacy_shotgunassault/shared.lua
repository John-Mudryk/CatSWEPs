...
SWEP.PrintName				= "Assault Shotgun"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.68, 0, -0.7)
...
SWEP.Type                       = "Shotgun" 
SWEP.Type_Displayed             = "Sol Pattern Mk. IIa" 

-- Attachments
SWEP.VElements = {
	["shotgunA"] = { type = "Model", model = "models/joazzz/weapons/shotgun_spacemarines_automatic.mdl", bone = "weapon_bone", rel = "", pos = Vector(-1.961, 0.704, -1.04), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 1} }
}

SWEP.WElements = {
	["shotgunA"] = { type = "Model", model = "models/joazzz/weapons/shotgun_spacemarines_automatic.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.102, 1.032, -3.231), angle = Angle(-10.551, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
