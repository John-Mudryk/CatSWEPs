...
SWEP.PrintName				= "Shoulder Heavy Bolter"		-- Weapon name (Shown on HUD)	
...
-- Attachments
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/heavyweapon_shoulder.mdl", bone = "weapon_bone", rel = "", pos = Vector(7.146, 1.531, -2.563), angle = Angle(6.855, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/heavyweapon_shoulder.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8.181, 3.076, -9.136), angle = Angle(-171.734, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
