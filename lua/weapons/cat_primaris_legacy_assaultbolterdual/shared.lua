...
SWEP.PrintName				= "Dual Assault Bolters"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Cawl Pattern Mk. IIIa + Cawl Pattern Mk. IIIa"
...
-- Attachments
SWEP.VElements = {
	["assaultbolter_l"] = { type = "Model", model = "models/zadkiel/weapons/primaris_assaultbolter.mdl", bone = "v_weapon.elite_left", rel = "", pos = Vector(0.787, -0.57, 4.447), angle = Angle(90, -90, 0), size = Vector(0.649, 0.649, 0.649), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["assaultbolter_r"] = { type = "Model", model = "models/zadkiel/weapons/primaris_assaultbolter.mdl", bone = "v_weapon.elite_right", rel = "", pos = Vector(-0.786, -0.297, 3.286), angle = Angle(90, -90, 0), size = Vector(0.649, 0.649, 0.649), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["assaultbolter_l"] = { type = "Model", model = "models/zadkiel/weapons/primaris_assaultbolter.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(8.855, 1.764, 0), angle = Angle(0, -10.7, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["assaultbolter_r"] = { type = "Model", model = "models/zadkiel/weapons/primaris_assaultbolter.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.855, 1.764, 0), angle = Angle(-174.892, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ViewModelBoneMods_Iron = {
	["v_weapon.magazine_right"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.magazine_left"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(45, -18, -45) },
	["v_weapon.elite_right"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(2, -0.75, 0), angle = Angle(0, -45, 0) },
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-51.737, -18.792, 45) },
	["v_weapon.elite_left"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 1.25, 0), angle = Angle(0, 45, 0) }
}
