...
SWEP.PrintName				= "Tigrus Bolt Pistol"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Tigrus Pattern Mk. Ib"
...
SWEP.WElements = {
	["boltpistolT"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_tigruspattern.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(9.592, 0.765, -3.31), angle = Angle(169.031, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
