...
SWEP.PrintName				= "Autoshotgun"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= "40k/shotgun-fire1.mp3"		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-4.797, -6.795, 2.576)
SWEP.IronSightsAng = Vector(-0.317, -3.254, 0)
...
SWEP.Type                       = "Shotgun" 
SWEP.Type_Displayed             = "Agripinaa Pattern Type IVs" 
...
SWEP.IronSightsPos_Reflex = Vector(-4.881, -5, 2.599)
SWEP.IronSightsAng_Reflex = Vector(-2.553, -3.069, 0)

SWEP.IronSightsPos_Short = Vector(-4.612, -10, 2.599)
SWEP.IronSightsAng_Short = Vector(-1.551, -3.1, 0)