...
SWEP.PrintName				= "Godwyn Combi-Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Godwyn Pattern Mk. IIIc"
...
SWEP.WElements = {
	["bolterGC"] = { type = "Model", model = "models/joazzz/weapons/bolter_combi.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.529, 1.264, -3.441), angle = Angle(-12.771, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
