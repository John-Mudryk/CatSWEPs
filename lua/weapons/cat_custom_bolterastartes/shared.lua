...
SWEP.PrintName				= "Bolter Astartes"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.434, -5.531, 0.99)
SWEP.IronSightsAng = Vector(-3.631, -2.349, -0.893)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Godwyn Mk. VIc"
