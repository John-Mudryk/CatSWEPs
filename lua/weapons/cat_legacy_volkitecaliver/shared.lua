...
SWEP.PrintName				= "Volkite Caliver"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= "asuran/fire.wav"		-- script that calls the primary fire sound
...
SWEP.Primary.Damage		= 1750	-- Base damage per bullet
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Mars-Omega Pattern Mk. I"
