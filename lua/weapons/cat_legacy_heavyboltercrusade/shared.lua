...
SWEP.PrintName				= "Crusade Heavy Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 640		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
SWEP.IronSightsPos = Vector(-7.08, -9.131, -6.68)
SWEP.IronSightsAng = Vector(6.626, -0.257, 0)
...
SWEP.Type_Displayed             = "Voss-Incarnadine Pattern Mk. I" 
...
SWEP.WElements = {
	["heavybolterCW"] = { type = "Model", model = "models/joazzz/weapons/v_heavybolter_crusade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-15.992, 8.13, -3.46), angle = Angle(-13.671, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
