...
SWEP.PrintName				= "Autocannon"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-35.137, -30.6, 114.444) },
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(8.208, 7.199, 11.409), angle = Angle(-5.776, -4.263, -3.202) },
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(27.184, 2.486, 4.659) },
	["weapon_bone"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(7.5, 0, 0) }
}
...
SWEP.Primary.Damage		= 800	-- Base damage per bullet
...
SWEP.IronSightsPos = Vector(-4.461, -16.455, 0.064)
SWEP.IronSightsAng = Vector(-0.364, -0.76, 0)
...
SWEP.Type                       = "Launcher" 
SWEP.Type_Displayed             = "Fortis Pattern Mk. III" 
