...
SWEP.WorldModel = "models/joazzz/weapons/combatknife.mdl"
SWEP.HoldType = "knife"
...
SWEP.Primary.Attacks = {
	{
		...
		["snd"] = Sound("weapons/tfa_kf2/katana/katana_swing_miss4.wav"), -- Sound ID
		["snd_delay"] = 0.26,
		["viewpunch"] = Angle(1, -5, 0), --viewpunch angle
		["end"] = 0.8, --time before next attack
		["hull"] = 42, --Hullsize
		["direction"] = "R", --Swing dir,
		["hitflesh"] = Sound("weapons/tfa_kf2/katana/melee_katana_04.wav"),
		["hitworld"] = Sound("weapons/tfa_kf2/katana/block02.wav"),
	},
	{
...
SWEP.Secondary.Attacks = {
	{
		["act"] = ACT_VM_SECONDARYATTACK, -- Animation; ACT_VM_THINGY, ideally something unique per-sequence
		["len"] = SWEP.Primary.Range * 1.25, -- Trace distance
		["dir"] = Vector(0, 20, -70), -- Trace arc cast
		["dmg"] = SWEP.Primary.Damage * 1.35, --Damage
		["dmgtype"] = DMG_SLASH, --DMG_SLASH,DMG_CRUSH, etc.
		["delay"] = 0.6, --Delay
		["spr"] = true, --Allow attack while sprinting?
		["snd"] = Sound("pulv_swing_hard.wav"), -- Sound ID
		["snd_delay"] = 0.5,
		["viewpunch"] = Angle(5, 0, 0), --viewpunch angle
		["end"] = 0.9, --time before next attack
		["hull"] = 16, --Hullsize
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/combatknife.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, -0.518, 2.596), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 17, [2] = 4} }
}

SWEP.WElements = {
	["sword"] = { type = "Model", model = "models/joazzz/weapons/combatknife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, -3), angle = Angle(180, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
}

SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Sol Pattern Mk. I"
