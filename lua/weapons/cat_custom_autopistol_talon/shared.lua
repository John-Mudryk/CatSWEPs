...
SWEP.PrintName				= "Talon Autopistol"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= "weapons/autogun/weapon_stubauto.wav"		-- script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-3.411, -5.853, -0.45)
SWEP.IronSightsAng = Vector(-7.343, 0.123, 0)
...
SWEP.Type_Displayed             = "Talon Mark III Short"

-- Attachments
SWEP.VElements = {
	["autopistol"] = { type = "Model", model = "models/autopistol.mdl", bone = "tag_weapon", rel = "", pos = Vector(12.871, 0.137, 0), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["autopistolW"] = { type = "Model", model = "models/autopistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.836, 0.945, -2.494), angle = Angle(169.151, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
