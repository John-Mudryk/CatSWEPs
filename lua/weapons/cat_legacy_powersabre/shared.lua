...
SWEP.WorldModel = "models/joazzz/weapons/powersword_saber.mdl"
SWEP.HoldType = "melee"
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/powersword_saber.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, -0.518, -0.5), angle = Angle(-3.507, -184.675, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 0, [2] = 1} }
}

SWEP.WElements = {
	["sword"] = { type = "Model", model = "models/joazzz/weapons/powersword_saber.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, 2), angle = Angle(0, 90, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 0, [2] = 1} },
}

SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Proteus Pattern Mk. IIa"
