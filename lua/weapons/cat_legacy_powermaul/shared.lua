...
SWEP.WorldModel = "models/joazzz/weapons/powermaul.mdl"
...
SWEP.VElements = {
	["powermaul"] = { type = "Model", model = "models/joazzz/weapons/powermaul.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.4, 0,-12.6), angle = Angle(0, 0, 0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {}}
}

SWEP.WElements = {
	["powermaul"] = { type = "Model", model = "models/joazzz/weapons/powermaul.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, 15), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {} },
}
