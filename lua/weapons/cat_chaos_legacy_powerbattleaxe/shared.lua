...
SWEP.PrintName = "Chaos Power Battleaxe"
...
SWEP.WorldModel = "models/rocks/weapons/forcesword.mdl"
...
SWEP.Primary.Attacks = {
	{
		...
		["hitflesh"] = Sound("weapons/tfa_kf2/zweihander/hitflesh_2.wav"),
		["hitworld"] = Sound("weapons/tfa_kf2/zweihander/swing_light_1.wav"),
	},
	{
...
SWEP.VElements = {
	["poweraxeCHB"] = { type = "Model", model = "models/joazzz/weapons/chaos/poweraxe_double.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.036, 0.079, 15.324), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 15, bodygroup = {[0] = 1, [1] = 0, [2] = 4, [3] = 0, [4] = 2} }
}

SWEP.WElements = {
	["poweraxeCHB"] = { type = "Model", model = "models/joazzz/weapons/chaos/poweraxe_double.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.149, 5.34, -23.809), angle = Angle(-7.422, 0, 170.569), size = Vector(1, 1, 1.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 15, bodygroup = {[0] = 1, [1] = 0, [2] = 4, [3] = 0} }
}

SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = nil 
SWEP.Type_Displayed             = "Butcher Pattern Mk. IIb"
