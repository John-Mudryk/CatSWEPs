...
SWEP.PrintName				= "Tigrus Dual Bolt Pistols"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 520		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Tigrus Pattern Mk. Ib + Tigrus Pattern Mk. Ib"
...
-- Attachments
SWEP.VElements = {
	["mag_l"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_straight.mdl", bone = "v_weapon.magazine_left", rel = "", pos = Vector(0, 1.5, 3.5), angle = Angle(90, -90, 0), size = Vector(0.55, 0.55, 0.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["mag_r"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_straight.mdl", bone = "v_weapon.magazine_right", rel = "", pos = Vector(0, 1.5, 3.5), angle = Angle(90, -90, 0), size = Vector(0.55, 0.55, 0.55), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["boltpistol_l"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_tigruspattern.mdl", bone = "v_weapon.elite_left", rel = "", pos = Vector(0.2, 0.25, 5.25), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 2} },
	["boltpistol_r"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_tigruspattern.mdl", bone = "v_weapon.elite_right", rel = "", pos = Vector(-0.201, 0.25, 5.25), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 2} }
}

SWEP.WElements = {
	["boltpistol_l"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_tigruspattern.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(10.102, 3.74, 0.694), angle = Angle(0, 166.994, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["boltpistol_r"] = { type = "Model", model = "models/joazzz/weapons/boltpistol_tigruspattern.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.744, 2.082, -0.877), angle = Angle(173.891, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ViewModelBoneMods_Iron = {
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-4, -6, -1.5), angle = Angle(45, 0, 0) },
	["v_weapon.magazine_right"] = { scale = Vector(0.109, 0.109, 0.109), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(-4, -5.353, 1.5), angle = Angle(-45, 0, 0) },
	["v_weapon.elite_right"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 1.445, 1.546), angle = Angle(0, -45, 0) },
	["v_weapon.magazine_left"] = { scale = Vector(0.109, 0.109, 0.109), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.elite_left"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, -1.176, 1.957), angle = Angle(0, 45, 0) }
}
