...
SWEP.PrintName = "Chainsword Astartes"
...
SWEP.WorldModel = "models/muschi/weapons/muschi_swep_chaonsword.mdl"
SWEP.HoldType = "melee"
...
SWEP.BlockTimeFade = 1.5 --Time for blocking to do minimum damage.  Does not include block window
SWEP.BlockSound = Sound("block_1.wav")
SWEP.BlockDamageCap = 250
SWEP.BlockDamageTypes = {
	DMG_SLASH,DMG_CLUB
}

SWEP.Secondary.CanBash = true
SWEP.Secondary.BashDamage = 420
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_chaonsword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.218, -1.5, 5), angle = Angle(-3.507, -180, -0), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[1] = 1} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_chaonsword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.5, 1.557, -6.5), angle = Angle(180, -90.169, -1.17), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} }
}
SWEP.InspectionActions = {ACT_VM_RECOIL1, ACT_VM_RECOIL2, ACT_VM_RECOIL3}

SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Mk. XI Hell's Teeth"
