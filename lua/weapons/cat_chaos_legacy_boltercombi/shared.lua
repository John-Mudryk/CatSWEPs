...
SWEP.PrintName				= "Chaos Combi-Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	["mag_bone"] = { scale = Vector(0.01, 0.01, 0.01), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["weapon_bone"] = { scale = Vector(0.01, 0.01, 0.01), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.IronSightsPos = Vector(-4.361, -3.827, 0.519)
SWEP.IronSightsAng = Vector(-3.494, -1.747, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Umbra Pattern Mk. Ic"

-- Attachments
SWEP.VElements = {
	["bolterCHC"] = { type = "Model", model = "models/joazzz/weapons/chaos/bolter_combi.mdl", bone = "weapon_bone", rel = "", pos = Vector(-0.278, 0.625, -0.842), angle = Angle(3.282, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 2, [3] = 3} },
	["mag"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_box.mdl", bone = "mag_bone", rel = "", pos = Vector(5.328, 0.158, -3.843), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true },
	["mag2"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_drum.mdl", bone = "mag_bone", rel = "", pos = Vector(6.199, 2, -6.6), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },	
	["mag22"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_drum.mdl", bone = "mag_bone", rel = "", pos = Vector(6.199, -2, -6.7), angle = Angle(0, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}


SWEP.WElements = {
	["bolterCHC"] = { type = "Model", model = "models/joazzz/weapons/chaos/bolter_combi.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.529, 1.264, -3.441), angle = Angle(-12.771, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 2, [3] = 3} },
	["mag"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_box.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.555, 1.21, 1.281), angle = Angle(-12.771, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = true },
	["mag2"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_drum.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.5, -1, 2.75), angle = Angle(-12.771, 0, -90), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["mag22"] = { type = "Model", model = "models/joazzz/weapons/bolter_mag_drum.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.5, 3.5, 3), angle = Angle(-12.771, 0, 90), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
}
...
SWEP.Attachments = {
    	[1] = { offset = { 0, 0 }, atts = { "cat_under_bolter", "cat_under_plasma", "cat_under_melta", "cat_under_flamer"}, order = 1 },
