...
SWEP.PrintName				= "Shoulder Lascannon"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/muschi/weapons/muschi_swep_lascannon_v.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_lascannon.mdl"	-- Weapon world model
SWEP.ViewModelFlip                      = false
...
SWEP.Primary.RPM			= 10		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
SWEP.Primary.Damage		= 12500	-- Base damage per bullet
...
-- Tracer Stuff
SWEP.TracerName		 = "effect_las_cannon"   -- Change to a string of your tracer name.  Can be custom. There is a nice example at https://github.com/garrynewman/garrysmod/blob/master/garrysmod/gamemodes/base/entities/effects/tooltracer.lua
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Sol Militarus Pattern Mk. IIa"

-- Attachments
SWEP.VElements = {
	["gun"] = { type = "Model", model = "models/joazzz/weapons/heavyweapon_shoulder.mdl", bone = "weapon_bone", rel = "", pos = Vector(-10.039, 0.773, 0.814), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 1} },
	["scope_short"] = { type = "Model", model = "models/rtcircle.mdl", bone = "ValveBiped.Bip01_Spine4", rel = "gun", pos = Vector(3.75, -11.601, 2.45), angle = Angle(0, 180, 0), size = Vector(0.625, 0.625, 0.625), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 1, bodygroup = {}, active = false }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/joazzz/weapons/heavyweapon_shoulder.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-8.181, 3.076, -9.136), angle = Angle(-171.734, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 1, bodygroup = {[0] = 1} }
}
