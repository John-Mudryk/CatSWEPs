...
SWEP.PrintName				= "Plasma Incinerator"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModelBoneMods = {
	...
	["weapon_bone"] = { scale = Vector(0.083, 0.083, 0.083), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.IronSightsPos = Vector(-4.12, -5, -0.48)
SWEP.IronSightsAng = Vector(-0.005, -1.739, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Mk. I Ragefire"
...
-- Attachments
SWEP.VElements = {
	["plasmaincinerator"] = { type = "Model", model = "models/zadkiel/weapons/primaris_plasmaincinerator.mdl", bone = "weapon_bone", rel = "", pos = Vector(1.108, 0.328, -1.662), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["scope_short"] = { type = "Model", model = "models/rtcircle.mdl", bone = "weapon_bone", rel = "plasmaincinerator", pos = Vector(-4.719, 0, 8.371), angle = Angle(45, 180, 0), size = Vector(0.111, 0.111, 0.111), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {}, active = false },
	["laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "weapon_bone", rel = "", pos = Vector(25.809, 0.307, -3.882), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
}

SWEP.WElements = {
	["plasmaincinerator"] = { type = "Model", model = "models/zadkiel/weapons/primaris_plasmaincinerator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.991, 1.889, -2.678), angle = Angle(-173.463, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(45.747, 2.02, -3.25), angle = Angle(-9.329, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
...
SWEP.Attachments = {
	...
	[3] = { offset = { 0, 0 }, atts = { "cat_lasersight"}, order = 3 },
...
SWEP.IronSightsPos_Short = Vector(-3.76, -16, -1.56)
SWEP.IronSightsAng_Short = Vector(12.346, -1.884, 0)
