...
SWEP.PrintName				= "Stubber"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/muschi/weapons/muschi_swep_stubber_v.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_stubber.mdl"	-- Weapon world model
SWEP.ViewModelFlip                      = false
...
SWEP.IronSightsPos = Vector(-5.08, -5.593, 2.615)
SWEP.IronSightsAng = Vector(0.409, -5.002, -1.153)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Voss Pattern Mk. VII"
...
SWEP.WElements = {
	["laser"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(29.757, -1.174, -9.544), angle = Angle(-13.221, 0, -0.541), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
