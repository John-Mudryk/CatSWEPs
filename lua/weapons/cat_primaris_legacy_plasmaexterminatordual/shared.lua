...
SWEP.PrintName				= "Dual Plasma Exterminators"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel				= "models/muschi/weapons/muschi_swep_plasmapistol.mdl"	-- Weapon world model
SWEP.ViewModelFlip                      = false
...
SWEP.Primary.DefaultClip		= 360	                -- Default number of bullets in a clip
...
SWEP.Type                       = "Pistol" 
SWEP.Type_Displayed             = "Belisarius Pattern Mk. IIIc + Belisarius Pattern Mk. IIIc"
...
-- Attachments
SWEP.VElements = {
	["plasmaexterminator_l"] = { type = "Model", model = "models/zadkiel/weapons/primaris_plasmaexterminator.mdl", bone = "v_weapon.elite_left", rel = "", pos = Vector(0.125, -0.5, 4), angle = Angle(90, -90, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["plasmaexterminator_r"] = { type = "Model", model = "models/zadkiel/weapons/primaris_plasmaexterminator.mdl", bone = "v_weapon.elite_right", rel = "", pos = Vector(0.125, -0.5, 4), angle = Angle(90, -90, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["plasmaexterminator_r"] = { type = "Model", model = "models/zadkiel/weapons/primaris_plasmaexterminator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.352, 2.805, -2.596), angle = Angle(-163.42, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["plasmaexterminator_l"] = { type = "Model", model = "models/zadkiel/weapons/primaris_plasmaexterminator.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(9.199, 2.756, 2.384), angle = Angle(11.239, -10.928, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ViewModelBoneMods_Iron = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-18, -4, 15) },
	["v_weapon.elite_right"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, -0.146, -0.366), angle = Angle(0, -45, 0) },
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(18, -4, -15) },
	["v_weapon.magazine_right"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.magazine_left"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.elite_left"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0.3, -0.101), angle = Angle(0, 45, 0) }
}
...
SWEP.HeatMax = 200
SWEP.HeatPerShot = 6
SWEP.OverheatThreshold = 200 -- optional, if you want to prevent firing
	...
	if SERVER then
		...
		if venting then
			if CurTime() >= (self.NextVentingSteam or 0) then
				local ed = EffectData()
				ed:SetEntity(self)
				util.Effect("plasma_venting_left", ed)
				util.Effect("plasma_venting_right", ed)
