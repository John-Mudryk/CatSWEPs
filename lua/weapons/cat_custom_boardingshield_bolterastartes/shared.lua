...
SWEP.PrintName				= "Boarding Shield + Bolter Astartes"		-- Weapon name (Shown on HUD)	
...
SWEP.DrawCrosshairIS			= false		-- set false if you want no crosshair
...
SWEP.MoveSpeed = 0.9
SWEP.AllowSprintAttack				  = true -- Allows firing the weapon while sprinting; false by default
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(10.715, -10.837, -2.678), angle = Angle(5.64, -8.471, 0) },
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -5), angle = Angle(0, 0, 0) },
	["weapon_bone"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -5), angle = Angle(0, 0, 0) },
	["mag_bone"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -5), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-3.948, -44.059, 68.255) },
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(37.023, 20.812, 23.853) }
}

SWEP.Primary.Sound			= "40k/b_fire6.wav"		-- script that calls the primary fire sound
...
SWEP.Primary.IronAccuracy = 0.0025	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.IronSightsPos = Vector(-4.617, -1.295, 6.25)
SWEP.IronSightsAng = Vector(-3.539, -2.381, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Praetorian Pattern Mk V + Godwyn Mk. VIc"
...
SWEP.VElements = {
	...
	["shield"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_shield.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(3.219, -1.695, 0.834), angle = Angle(22.176, 152.57, -11.837), size = Vector(0.684, 0.684, 0.684), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }

}

SWEP.WElements = {
	["knife"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_knife_astartes.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.687, 1.208, -5.719), angle = Angle(167.636, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["knife2"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_chaonsword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(26.097, 1.296, -7.325), angle = Angle(0, 90, 103.872), size = Vector(0.402, 0.423, 0.301), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false },
	["shield"] = { type = "Model", model = "models/muschi/weapons/muschi_swep_shield.mdl", bone = "ValveBiped.Bip01_L_Forearm", rel = "", pos = Vector(6.03, -5.229, 3.262), angle = Angle(15.107, 170.302, -81.951), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
...
SWEP.RiotShieldMaximum = 0 -- 90% damage reduction
