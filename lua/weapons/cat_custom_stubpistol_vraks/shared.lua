...
SWEP.PrintName				= "Stub Pistol Vraks"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= "weapons/autogun/weapon_stubdmr.wav"		-- script that calls the primary fire sound
SWEP.Primary.RPM			= 267		-- This is in Rounds Per Minute This is in Rounds Per Minute / RPM
...
SWEP.IronSightsPos = Vector(-3.537, -5.481, -0.65)
SWEP.IronSightsAng = Vector(1.36, -0.049, 0)
...
SWEP.Type                       = "Rifle"
SWEP.Type_Displayed             = "Vraks Pattern Mk. III"

-- Attachments
SWEP.VElements = {
	["stubpistol"] = { type = "Model", model = "models/stubpistol.mdl", bone = "tag_weapon", rel = "", pos = Vector(11.515, 0.328, 0), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["stubpistolW"] = { type = "Model", model = "models/stubpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(15.248, 0.707, -3.416), angle = Angle(165.852, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
