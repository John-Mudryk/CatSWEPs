...
SWEP.PrintName				= "Crusade Bolter"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-4.407, -4.994, 1.072)
SWEP.IronSightsAng = Vector(-6.159, -1.79, 0)
...
SWEP.Type                       = "Rifle" 
SWEP.Type_Displayed             = "Crusade Pattern Mk. I"

-- Attachments
SWEP.VElements = {
	["bolter1"] = { type = "Model", model = "models/joazzz/weapons/bolter_mk1.mdl", bone = "weapon_bone", rel = "", pos = Vector(-2.599, 0.521, -3.731), angle = Angle(5.947, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}


SWEP.WElements = {
	["bolter1"] = { type = "Model", model = "models/joazzz/weapons/bolter_mk1.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(13.529, 1.264, -3.441), angle = Angle(-12.771, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
