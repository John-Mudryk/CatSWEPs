...
local guard_names = {
	...
	[10] = "Blood Gladius",
	[11] = "Honour Guard",
	[12] = "Grandfather's Embrace",
	[13] = "Contagion Star",
	[14] = "Torment Cross",
	[15] = "Perfected Crescent",
	[16] = "Planned Sickle",
	[17] = "Imbalanced Change",
}
...
local function OpenSwordForgeMenu(wep)
	...
	for _, guard in ipairs(guard_options) do
		local name = guard_names[guard] or ("Guard " .. guard)
...
function ATTACHMENT:Attach(wep)
	...
	hook.Add("HUDPaint", GetHookID(wep) .. "_HUD", function()
		...
		local guard_name = guard_names[guard] or ("Guard " .. tostring(guard))
