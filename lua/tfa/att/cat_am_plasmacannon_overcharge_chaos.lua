...
ATTACHMENT.WeaponTable = {
	["Primary"] = {
		...
		["RPM"] = function(wep, stat) return stat / 3 end,
	...
	["TracerName"] = "tracer_laser_bigger_plasma_chaos",
...
function ATTACHMENT:Attach(wep)
	...
	wep.JamChance = _G.JamChance + 0.5
	wep.JamFactor = _G.JamFactor + 2
...
function ATTACHMENT:CustomBulletCallback(wep, attacker, trace, dmginfo)
	util.BlastDamage( wep, attacker, trace.HitPos, dmginfo:GetDamage()/50, dmginfo:GetDamage()/5 )
end
