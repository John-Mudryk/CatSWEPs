...
ATTACHMENT.Description = { TFA.Attachments.Colors["="], "Charge the plasma and release it as a concentrated projectile", TFA.Attachments.Colors["+"], "Large area damage", "Increased Damage", TFA.Attachments.Colors["-"], "Decreased travel speed", "Decreased fire-rate", "Double waste of magazine" }
ATTACHMENT.Icon = "sprites/strider_blackball" 

ATTACHMENT.WeaponTable = {
	["Primary"] = {
		["Projectile"] = "cat_plasma_bolt_small_chaos", -- Change from hitscan to projectile
