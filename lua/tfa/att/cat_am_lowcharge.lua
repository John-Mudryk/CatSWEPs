...
ATTACHMENT.Icon = "entities/effect_cat_lasgun.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
ATTACHMENT.WeaponTable = {
	["Primary"] = {
		...
		["Kickback"] = function( wep, stat ) return stat * 0.5 end,
