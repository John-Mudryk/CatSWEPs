...
function ENT:Explode()
	...
	util.BlastDamage(self, self.Owner, self:GetPos(), 300, self.Damage)
	...
	shake:SetKeyValue("duration", tostring(self.Damage / 2000)) -- Time of shake
	...
	self:EmitSound("weapons/autocannonfire.wav")
