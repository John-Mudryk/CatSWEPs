...
function ENT:Explode()
	...
	util.BlastDamage(self, self.Owner, self:GetPos(), 50, 10000)
	shake = ents.Create("env_shake")
	shake:SetOwner(self.Owner)
	shake:SetPos(self:GetPos())
	shake:SetKeyValue("amplitude", tostring(20)) -- Power of the shake
	shake:SetKeyValue("radius", tostring( 200  ) ) -- Radius of the shake
	shake:SetKeyValue("duration", tostring( self.Damage / 5000 )) -- Time of shake
