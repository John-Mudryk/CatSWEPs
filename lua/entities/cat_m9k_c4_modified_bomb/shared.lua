...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/muschi/weapons/muschi_grenade_melta_bomb.mdl")
...
function ENT:Explosion()
	...
	util.Effect("cat_melta_explosion", effectdata)
	...
	local effectdata = EffectData()
		...
		util.BlastDamage( self.Entity, self.Owner, self.Entity:GetPos() + Vector(0,0,5), 500, 10000 )
		util.BlastDamage( self.Entity, self.Owner, self.Entity:GetPos() + Vector(0,0,5), 1000, 100 )
		util.BlastDamage( self.Entity, self.Owner, self.Entity:GetPos() + Vector(0,0,5), 250, 100000 )
		local effectdata = EffectData()
		effectdata:SetOrigin( self.Entity:GetPos() )
		util.Effect( "cat_massive_explosion", effectdata )
		util.ScreenShake( self.Entity:GetPos(), 1000, 50, 1, 1600 )
		self:Remove()
...
function ENT:Draw()
	...
	cam.Start3D2D(TargetPos, FixAngles, .07)
		draw.SimpleText(self.Text, "CloseCaption_Normal", 0, 80, Color(165, 0, 0, 255), 1, 1)
	cam.End3D2D() 
end
