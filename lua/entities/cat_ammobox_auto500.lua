...
ENT.Type = "anim"
ENT.Base = "base_anim"
ENT.PrintName = "Auto ammo types 500"
ENT.Category = "Cat's AMMO"
ENT.Spawnable = true
ENT.AdminOnly = true
ENT.Class = ""
ENT.MyModel = "models/Items/ammocrate_grenade.mdl"
...
if SERVER then
	...
	function ENT:Use(activator, caller)
		local AmmoGive = {
			...
			"cat_custom_hellgun",
			"cat_custom_hellgunscion",
			"cat_custom_hellgunstormtrooper",
			"cat_custom_volleygun",
		}
		...
		if IsValid(activator) and activator:IsPlayer() then
			...
			if table.HasValue(AmmoGive, WeaponClass) then
				...
				ToGive = 500 - (AmmoCount + Weapon:Clip1())
			end
