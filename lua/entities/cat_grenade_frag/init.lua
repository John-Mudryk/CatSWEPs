...
ENT.Model = "models/muschi/weapons/muschi_grenade_frak.mdl"
ENT.FuseTime = 5          -- Default fuse time in seconds (modifiable)
ENT.Damage = 250          -- Blast damage
ENT.Radius = 300          -- Blast radius
ENT.StickOnImpact = false -- Change to true if you want it to stick to surfaces
ENT.IsImpact = false
