...
function ENT:Explosion()
	...
	local effectdata = EffectData()
		...
		util.BlastDamage( self.Entity, self.Owner, self.Entity:GetPos() + Vector(0,0,5), 1000, 10000 )
		util.BlastDamage( self.Entity, self.Owner, self.Entity:GetPos() + Vector(0,0,5), 2000, 50 )
