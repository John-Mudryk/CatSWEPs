...
-- Materials
local Mat_Beam = Material("trails/physbeam")
...
function EFFECT:Render()
    ...
    local beamColor = Color(155, 0, 255, alpha) -- Orange Melta blast
    local impactColor = Color(255, 0, 255, alpha) -- Impact tip glow
