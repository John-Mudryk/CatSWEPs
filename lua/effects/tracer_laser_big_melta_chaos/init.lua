...
local Mat_Glow = Material("sprites/glow04_noz") -- Extra purple glow
...
local beamcol = Color(200, 50, 255, 255) -- Main beam color (Purple)
local glowcol = Color(180, 50, 255, 200) -- Extra purple glow
...
function EFFECT:Render()
    ...
    for i = 0, 100 do
        ...
        render.DrawSprite(effectPos, 15, 15, glowcol)
        ...
        if particle then
            ...
            particle:SetColor(200, 50, 255) -- Purple fire
